...
A from-scratch implementation of a deep artificial neural network that supports any number of hidden layers / neurons per layer (not optimized for speed, made just for fun - I wanted to avoid relying on libraries like PyTorch or Tensorflow as a challenge to myself).
